...
class InsuranceController extends Controller
{
    ...
    public function updateInsurance(Request $request, $id) {
        ...
        return redirect()->route('listInsurance')->with('message', 'Berhasil mengupdate data Asuransi!');
    }
    ...
    public function createInsurance(Request $request) {
        ...
        return redirect()->route('listInsurance')->with('message', 'Berhasil menambah list Asuransi!');
    }
    ...
    public function deleteInsurance ($id) {
        ...
        return redirect()->route('listInsurance')->with('error', 'Berhasil menghapus Asuransi!');
    }
}
