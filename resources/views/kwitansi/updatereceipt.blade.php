      ...
      <div class="card-body">
        <form method="POST" action="{{ route('updateReceipt', $receipt->id) }}" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <div class="input-group input-group-merge">
              <input type="text" class="form-control" id="price" name="price" value="{{(isset($receipt->price))?$receipt->price:old('price')}}" placeholder="Harga" aria-label="Harga" aria-describedby="basic-icon-default-fullname2" />
            </div>
          </div>  
          <div class="mb-3">          
...
<script>
  ...
  harga.defaultValue = formatRupiah(harga.value, 'Rp. ')
  ...
  diskon.defaultValue = formatRupiah(diskon.value, 'Rp. ')
