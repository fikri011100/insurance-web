...
<form class="row g-3 justify-content-center">
    ...
    <div class="mb-3">
        ...
        <div class="input-group input-group-merge">
            <input type="text" class="form-control" id="discount" name="discount" type-currency="IDR" placeholder="Discount" aria-label="Discount" aria-describedby="basic-icon-default-fullname2" />
        </div>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div class="input-group input-group-merge">
            <input type="text" class="form-control" id="price" name="price" type-currency="IDR" placeholder="Biaya" aria-label="Biaya" aria-describedby="basic-icon-default-fullname2" />
        </div>
    </div>  
    <div class="mb-3">          
